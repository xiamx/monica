...
return [
    ...
    'sidebar_settings_subscriptions' => '大会员',
    ...
    'reset_desc' => '您确定要重置您的帐户吗？这将删除所有联系人以及与之关联的数据。您的帐户本身将不会被删除。',
    'reset_title' => '重置您的账户',
    'reset_cta' => '重置帐户',
    'reset_notice' => '您确定要重新设置帐户吗？此操作不可撤销。',
    'reset_success' => '您的帐户已成功重置',
    'delete_notice' => '您确定要重新设置帐户吗？此操作不可撤销。',
    'delete_cta' => '删除帐户',
    ...
    'subscriptions_account_current_plan' => '您当前购买的大会员服务',
    'subscriptions_account_current_paid_plan' => '您当前的购买是：:name，大会员，感谢您的支持！',
    'subscriptions_account_next_billing' => '您的大会员将在 <strong>:date</strong> 到期',
    ...
    'subscriptions_account_invoices_subscription' => '大会员购买周期：:startDate 至 :endDate',
    ...
    'subscriptions_upgrade_charge' => '您将支付 :price ，服务到期日期：:date。',
    'subscriptions_upgrade_charge_handled' => '支付服务由第三方支付平台 <a href=":url">Stripe</a> 提供。',
    'subscriptions_upgrade_success' => '感谢您的支持！',
    ...
    'subscriptions_plan_year_cost' => '￥55 /年',
    'subscriptions_plan_year_cost_save' => '您可以节省 25%',
    'subscriptions_plan_year_bonus' => '长期用起来更超值',
    'subscriptions_plan_month_title' => '按月支付',
    'subscriptions_plan_month_cost' => '￥6 /月',
    ...
    'import_need_subscription' => '您需要购买大会员才能导入联系人',
    ...
    'personalisation_paid_upgrade' => '这是一个大会员的独享功能. 您可在《设置-大会员》内购买。',
