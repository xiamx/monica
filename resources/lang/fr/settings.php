...
return [
    ...
    'export_sql_explanation' => 'Exporter les données au format SQL vous permet de récupérer vos données et de les importer dans votre propre instance de ClxPRM. Ceci n’a d’intérêt que si vous avez votre propre serveur.',
    ...
    'users_list_invitations_explanation' => 'Voici les personnes que vous avez invité à rejoindre ClxPRM comme collaborateurs.',
    ...
    'subscriptions_account_upgrade_title' => 'Mettez à niveau ClxPRM aujourd’hui et ayez des relations encore plus significatives.',
    'subscriptions_account_upgrade_choice' => 'Choisissez une offre ci-dessous et rejoignez plus de :customers personnes qui ont mis à niveau leur ClxPRM.',
    ...
    'subscriptions_downgrade_thanks' => 'Merci beaucoup d’avoir essayé l’offre payante. Nous continuons à apporter de nouvelles fonctionnalités sur ClxPRM tout le temps – vous pouvez donc revenir à l’occasion pour voir si vous pourriez à nouveau être intéressé·e pour prendre un abonnement.',
    ...
    'subscriptions_help_opensource_desc' => 'ClxPRM est un projet open source. Il est le fruit du travail d’une communauté de bénévoles qui veulent juste fournir un outil pour le bien de tous. Être un projet open source signifie que le code est disponible pour tous sur GitHub, et que tout le monde peut l’inspecter, le modifier et l’améliorer. Tout l’argent que nous récoltons sert uniquement à créer des fonctionnalités, avoir plus de serveurs puissants, aider à payer les factures. Merci pour votre aide. Nous ne pourrions rien faire sans vous – littéralement.',
    ...
    'subscriptions_help_discounts_desc' => 'En effet ! ClxPRM est gratuit pour les étudiants, les organismes sans but lucratif et les organismes de bienfaisance. Il suffit de contacter le <a href=":support">support</a> avec un justificatif de votre statut et nous allons appliquer ce statut spécial dans votre compte.',
    ...
    'api_description' => 'L’API peut être utilisée pour manipuler les données de ClxPRM depuis une application externe, comme une application mobile par exemple.',
    ...
    'personalization_title' => 'Ici vous pouvez configurer les différents paramètres de votre compte. Ces fonctionnalités sont pour les « utilisateurs avancés » qui veulent un contrôle maximal sur ClxPRM.',
