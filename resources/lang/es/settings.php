...
return [
    ...
    'export_sql_explanation' => 'Exportar tus datos en formato SQL te permite tomar tu propia información he importarla en tu propia instancia de ClxPRM. Esto es valioso solo si tú tienes tu propio servidor.',
    ...
    'users_list_invitations_explanation' => 'Below are the people you’ve invited to join ClxPRM as a collaborator.',
    ...
    'subscriptions_account_upgrade_title' => 'Upgrade ClxPRM today and have more meaningful relationships.',
    'subscriptions_account_upgrade_choice' => 'Pick a plan below and join over :customers persons who upgraded their ClxPRM.',
    ...
    'subscriptions_downgrade_thanks' => 'Thanks so much for having tried the paid plan. We keep adding new features on ClxPRM all the time – so you might want to come back in the future to see if you might be interested in taking a subscription again.',
    ...
    'subscriptions_help_discounts_desc' => 'We do! ClxPRM is free for students, and free for non-profits and charities. Just contact <a href=":support">the support</a> with a proof of your status and we’ll apply this special status in your account.',
    ...
    'api_description' => 'The API can be used to manipulate ClxPRM’s data from an external application, like a mobile application for instance.',
    ...
    'personalization_title' => 'Here you can find different settings to configure your account. These features are more for “power users” who want maximum control over ClxPRM.',
