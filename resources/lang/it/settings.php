...
return [
    ...
    'export_sql_explanation' => 'Esportare i dati in formato SQL ti permette di importarli nella tua istanza di ClxPRM. Ciò ha senso solo se hai un tuo proprio server.',
    'export_sql_cta' => 'Esporta a SQL',
    'export_sql_link_instructions' => 'Nota: <a href=":url">leggi le istruzioni</a> per capire come importare questo file nella tua istanza di ClxPRM.',
    ...
    'users_list_invitations_explanation' => 'Qui sotto trovi gli inviti a ClxPRM come collaboratori',
    ...
    'subscriptions_account_upgrade_title' => 'Aggiorna ClxPRM oggi e ottieni relazioni più significative.',
    'subscriptions_account_upgrade_choice' => 'Scegli un piano e unisciti alle :customers persone abbonate a ClxPRM.',
    ...
    'subscriptions_downgrade_thanks' => 'Grazie infinite per aver provato il piano a pagamento. Continuiamo ad aggiungere nuove funzionalità a ClxPRM – quindi torna a trovarci in futuro per vedere se può interessarti tornare al piano a pagamento.',
    ...
    'subscriptions_help_discounts_desc' => 'Sì! ClxPRM è gratuita per studenti, no-profit e organizzazioni di beneficienza. Basta contattare <a href=":support">il supporto clienti</a> con una prova del tuo status, e aggiorneremo il tuo account.',
    ...
    'api_description' => 'L\'API puó essere usata per manipolare le informazioni in ClxPRM da un\'applicazione esterna, ad esempio da un\'applicazione per smartphone.',
    ...
    'personalization_title' => 'Qui puoi trovare diverse impostazioni per personalizzare il tuo account. Queste funzionalità sono pensate per utenti esperti che vogliono massimizzare il loro controllo su ClxPRM.',
    ...
    'personalization_contact_field_type_modal_delete_description' => 'Rimuovere forma di contatto? Questa azione rimuoverá la forma di contatto da TUTTE le persone nel tuo account di ClxPRM.',
